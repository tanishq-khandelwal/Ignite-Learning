...
const Signup = () => {
  ...
  try {
    ...
    // Check if res.payload is defined and res.payload.success is true
    if (res.payload?.success) {
      // Redirect to login page or show a success message
      navigate("/login");
    } else {
      // Handle the case where res.payload is undefined or res.payload.success is false
      toast.error(res.payload?.message || "Failed to create account");
    }
